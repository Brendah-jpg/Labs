...
<html>
	...
	<body>
		...
		<strong>Your API key: </strong>(Note that if your API key is already in use by already running applications, generating a new key wil stop the application from functioning)<br>
